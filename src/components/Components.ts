...
class Components {
  ...
  public static readonly position = new ComponentTypeDefinition<PositionComponent>(2 ** 0);
  public static readonly sprite = new ComponentTypeDefinition<SpriteComponent>(2 ** 1);
  public static readonly camera = new ComponentTypeDefinition<CameraComponent>(2 ** 2);
  public static readonly speed = new ComponentTypeDefinition<SpeedComponent>(2 ** 3);
