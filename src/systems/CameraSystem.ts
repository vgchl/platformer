import { CameraComponent, Components, PositionComponent, SpriteComponent } from '../components';
import { Entity, System } from '../engine';

class CameraSystem extends System {
  public update(entities: Entity[]): void {
    this.filterByComponentMask(entities, Components.camera.id).forEach(entity => {
      ...
      this.filterByComponentMask(entities, Components.sprite.id).forEach(entity => {
